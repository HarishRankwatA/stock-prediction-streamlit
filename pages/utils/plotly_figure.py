...
def plotly_table(dataframe):
    ...
    headers = ["<b></b>"] + ["<b>" + str(col) + "</b>" for col in dataframe.columns]
    ...
    fig = go.Figure(data=[go.Table(
        ...
        cells=dict(
            ...
            fill_color=[
                [rowOddColor if i % 2 else rowEvenColor for i in range(len(dataframe))]
...
def close_chart(dataframe, num_period=False):
    ...
    fig.update_layout(height = 500, margin=dict(l=0, r=20, t=20, b=0), plot_bgcolor = 'white', paper_bgcolor = '#E1E1E1', legend=dict(
        yanchor="top",
        xanchor="right"
    ))
    return fig
...
def candlestick(dataframe, num_period):
    ...
    fig.update_layout(showlegend=False, height = 500, margin=dict(l=0, r=20, t=20, b=0), plot_bgcolor = 'white', paper_bgcolor = '#E1E1E1')
    return fig
...
def RSI(dataframe, num_period):
    ...
    fig.update_layout(yaxis_range=[0,100],
                      height=200, plot_bgcolor = 'white', paper_bgcolor = '#E1E1E1', margin=dict(l=0, r=0, t=0, b=0), legend=dict(orientation="h",
                      yanchor="top",
                      y=1.02,
                      xanchor="right",
                      x=1
...
def MACD(dataframe, num_period):
    ...
    fig.add_trace(go.Scatter(
        ...
        name = 'MACD Signal', marker_color='red', line = dict(width=2, color = 'red', dash='dash'),
    ))
    ...
    fig.update_layout(
        height=200, plot_bgcolor = 'white', paper_bgcolor = '#E1E1E1', margin=dict(l=0, r=0, t=0, b=0), legend=dict(orientation="h",yanchor="top",y=1.02,xanchor="right",x=1))
